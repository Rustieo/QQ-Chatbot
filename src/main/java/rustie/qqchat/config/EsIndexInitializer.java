...
//        // 检查索引是否存在
//        BooleanResponse existsResponse = esClient.indices().exists(ExistsRequest.of(e -> e.index("chat_knowledge_base")));
//        if (!existsResponse.value()) {
//            createIndex();
//        } else {
//            logger.info("索引 'chat_knowledge_base' 已存在");
//        }
//    }
//
//    /**
...
//                .index("chat_knowledge_base") // 索引名称
//                .withJson(new StringReader(mappingJson)) // 使用 JSON 文件定义映射
//        );
//        esClient.indices().create(createIndexRequest);
//        logger.info("索引 'chat_knowledge_base' 已创建");
//    }
//}